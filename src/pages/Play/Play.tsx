    ...
    <div className="w-full min-h-full">
      <div className="container flex items-start justify-center p-[1rem]">
        <div className="play-card">
          <h1 className='text-[32px] sm:text-[48px] text-center'>Association: Boxing club</h1>
          ...
          <div className='flex flex-col w-full sm:flex-row items-center mt-[2rem] gap-[2rem] sm:gap-[1rem]'>
            <div className="ticket-info text-[1.5rem] w-full max-w-[448px] flex flex-col items-center justify-center h-[320px] sm:text-[2rem] rounded-[12px] p-[1rem] bg-white">
              <div><span>Number of tickets:</span><span>300</span></div>
              <div><span>Ticket price:</span><span>20$</span></div>
              <div><span>Total prizes:</span><span></span></div>
              <div><span>Biggest prize:</span><span></span></div>
            </div>

            <form className="ticket-form w-full p-[1rem] flex flex-col gap-[1rem] rounded-[12px] bg-white">
              <input

...
const Pay = () => {
    ...
    return (
        <div className='w-full min-h-full '>
            <div className="container p-[1rem] w-full  flex start justify-center">
                <div className="w-full bg-white  rounded-[24px] max-w-[757px] mx-auto xl:relative p-[1rem] sm:p-[3rem] xl:pr-[10rem]">

                    <div className="flex-1  flex flex-col gap-[1rem] text-white p-[2rem] bg-[#0047FF] p-[1rem] rounded-[24px] xl:absolute mb-[3rem] xl:mb:0 right-[-34%] xl:max-w-[375px]">
                        ...
                        <button className='px-[1rem] text-[15px] w-full text-[#0047FF] rounded-[8px] py-[.8rem] hover:bg-blue-100 cursor-pointer duration-300 bg-white'>
                            Proceed
                        </button>
                    </div>
